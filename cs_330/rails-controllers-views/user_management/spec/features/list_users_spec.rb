...
RSpec.describe "listing users" do
  it "displays list of existing users" do
    ...
    user2 = User.create(first_name: "Johnny", last_name: "Chimpo", email: "johnny@gmail.com", password: "password")
    user3 = User.create(first_name: "Tom", last_name: "Riddle", email: "tom@gmail.com", password: "password")
